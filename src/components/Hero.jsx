    ...
    >
      ...
      <div className="relative max-w-7xl mx-auto w-full px-6 md:px-10 grid lg:grid-cols-[1.1fr_0.9fr] gap-16 items-center">
        ...
        >
          ...
          <motion.div
            variants={item}
            className="mt-6 flex flex-wrap gap-x-3 gap-y-1 text-lg md:text-xl text-[--color-text-muted] font-medium"
          >
          ...
          <motion.a
            ...
            className="mt-8 flex md:hidden flex-col items-center gap-2 text-xs text-[--color-text-dim] hover:text-[--color-text-muted] transition-colors focus-ring"
          >
